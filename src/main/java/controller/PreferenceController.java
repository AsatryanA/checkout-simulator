...
public class PreferenceController extends Controller {
    ...
    public ChoiceBox<String> workingHours;
    ...
    private void saveSettings() {
        ...
        PropertiesTool.saveProperties(workingHours.getId(), workingHours.getValue());
    ...
    private void initSettings() {
        prefBusyDegree.valueProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue.doubleValue() == 0) {
                busyDegreeDesc.setText("  շատ քիչ");
            } else if (newValue.doubleValue() == 25) {
                busyDegreeDesc.setText("  քիչ");
            } else if (newValue.doubleValue() == 50) {
                busyDegreeDesc.setText("  նորմալ");
            } else if (newValue.doubleValue() == 75) {
                busyDegreeDesc.setText("  շատ");
            } else if (newValue.doubleValue() == 100) {
                busyDegreeDesc.setText("  առավելագույն");
            }
        });
        prefBusyDegree.setValue(Double.parseDouble(
        ...
        workingHours.getItems().addAll("1", "2", "3", "4", "5", "6", "7", "8");
        workingHours.setValue(
                PropertiesTool.readProperties(workingHours.getId(), "1")
        );
